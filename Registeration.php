...
<div class="container">
 ...
 <table class="content">
    ...
    <tr><td><input type="text" name="city"></td><td><select name="state">
        ...
        <tr><td>Pincode:</td><td>Contact:</td></tr>
    <tr><td><input type="number" name="pin"></td><td><input type="text" name="cont"></td></tr>
...
<hr>
<button class="btn">Login</button><button class="btn">Reset</button>
</div>
</form>
<div>
