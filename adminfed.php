...
<body>
    ...
    <div class="div1" id="grad">
        ...
        <table style="font-size:20px;text-align:justify;width:850px;"border=1>
            <tr><td colspan="4" style="text-align:center;font-size:30px;"><b><u>**Feedback**</u></b></td></tr>
            <tr style="background-color:black;color:white;"><td>Student-ID</td><td>Date</td><td>Subject</td><td>Message</td></tr>
            
       
            <?php
            $con=mysqli_connect("127.0.0.1","root","","online_exam");
$sql="select feedback.sid,feedback.date,feedback.subject,feedback.message from feedback"; 
